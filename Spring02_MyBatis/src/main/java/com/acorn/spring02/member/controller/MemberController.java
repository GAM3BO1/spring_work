package com.acorn.spring02.member.controller;
...
import com.acorn.spring02.member.dao.MemberDao;
import com.acorn.spring02.member.dto.MemberDto;

@Controller
public class MemberController {
	@Autowired
	private MemberDao dao;	//new MemberDaoImpl() 생성
